...
public class LoopsScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i = 0; i < 100; i++)
        {
            if (i == 0)
            {
                Debug.Log("El 0 es un número especial...");
            }
        ...
        for (int number = 2; number < 100; number++)
        {
            ...
            Debug.Log("Algoritmo de búsqueda");
            int objectPos = -1;
            for(int i = 0; i < studentsNames.Count; i++)
            {
                Debug.Log("Vamos por la iteración número 0" + i);
            ...
            {
                Debug.Log("El objeto que buscas se encuentra en la posición " + objectPos);
            }
        }
    }
